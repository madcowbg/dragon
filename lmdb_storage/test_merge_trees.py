...
class TestingMergingOfTrees(IsolatedAsyncioTestCase):
    ...
    def test_merge_combining(self):
        ...
        with env.objects(write=True) as objects:
            ...
            merged = TakeOneFile(objects).merge_trees(objects_by_root)
            self.assertEqual([
                ('$ROOT', 1),
    ...
    def test_merge_raw(self):
        ...
        with env.objects(write=True) as objects:
            merged_ids = TakeOneFile(objects).merge_trees(
    ...
    def test_merge_threeway(self):
        ...
        with env.objects(write=True) as objects:
            ...
            merged_ids = ThreewayMerge(
                ...
                fetch_new={'full', 'hoard'}).merge_trees(ObjectsByRoot.from_map({
    ...
    def test_merge_threeway_incrementally(self):
        ...
        with env.objects(write=True) as objects:
            ...
            merged_ids = ThreewayMerge(
                objects, current='empty', staging='staging', others=['hoard'], fetch_new={'hoard'}).merge_trees(
