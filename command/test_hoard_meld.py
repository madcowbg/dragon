...
class TestHoardCommand(unittest.TestCase):
    ...
    def test_recover(self):
        ...
        res = hoard_cmd.recover(source=dump_path, dest=recover_path, move=False, junk_folder="_tralala_")
        self.assertEqual(
            "A/test.me.1\n"
            "A/wat/test.me.2\n"
        ...
        res = hoard_cmd.recover(source=dump_path, dest=recover_path, move=True)
        self.assertEqual(
            "M/test.me.1\n"
            "M/wat/test.me.2\n"
