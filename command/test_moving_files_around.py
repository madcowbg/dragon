...
class TestIncomingRepos(IsolatedAsyncioTestCase):
    ...
    async def test_adding_full_then_adding_partial(self):
        ...
        self.assertEqual([
            ...
            "NEEDS_MORE_COPIES (2) ['repo-full-name', 'repo-backup-name'] test.me.5",
            'd wat/test.me.3',
            "NEEDS_MORE_COPIES (2) ['repo-full-name', 'repo-backup-name'] wat/test.me.6",
            'After:',
            'Remote repo-backup-name current=3a0889 staging=3a0889 desired=ea749c',
            'Remote repo-full-name current=1ae17c staging=1ae17c desired=ea749c',
            'Remote repo-incoming-name current=98e373 staging=3d1726 desired=None',
            'Remote repo-partial-name current=f9bfc2 staging=f9bfc2 desired=f9bfc2',
            'DONE'], res.splitlines())
        ...
        self.assertEqual([
            ...
            'LOCAL_COPY wat2/test.me.3',
            'REMOTE_COPY [repo-full-name] wat2/test.me.4',
            'repo-backup-name:',
            # 'd test.me.4',
            'd wat/test.me.3',
            'After:',
        ...
        self.assertEqual([
            ...
            'After:',
            'Remote repo-backup-name current=ea749c staging=3a0889 desired=ea749c',
            'Remote repo-full-name current=ea749c staging=1ae17c desired=ea749c',
            'Remote repo-incoming-name current=f0355b staging=3d1726 desired=None',
            'Remote repo-partial-name current=f9bfc2 staging=f9bfc2 desired=f9bfc2',
            'DONE'], res.splitlines())
    ...
    async def test_moving_files_twice_fallbacks_to_get(self):
        ...
        self.assertEqual([
            'Before push:',
            'Remote repo-backup-name current=3a0889 staging=3a0889 desired=e13afb',
            'Remote repo-full-name current=fa1f81 staging=fa1f81 desired=e13afb',
            'Remote repo-incoming-name current=3d1726 staging=3d1726 desired=None',
            'Remote repo-partial-name current=f9bfc2 staging=f9bfc2 desired=f9bfc2',
            'repo-full-name:',
            'REMOTE_COPY [repo-incoming-name] test.me.5',
            ...
            'After:',
            'Remote repo-backup-name current=3a0889 staging=3a0889 desired=e13afb',
            'Remote repo-full-name current=e13afb staging=fa1f81 desired=e13afb',
            'Remote repo-incoming-name current=3d1726 staging=3d1726 desired=None',
            'Remote repo-partial-name current=f9bfc2 staging=f9bfc2 desired=f9bfc2',
            'DONE'], res.splitlines())
        ...
        self.assertEqual([
            ...
            'LOCAL_COPY wat3/test.me.3',
            'repo-backup-name:',
            'd wat/test.me.3',
            'After:',
            'Remote repo-backup-name current=e13afb staging=3a0889 desired=e13afb',
            'Remote repo-full-name current=e13afb staging=fa1f81 desired=e13afb',
            'Remote repo-incoming-name current=3d1726 staging=3d1726 desired=None',
            'Remote repo-partial-name current=f9bfc2 staging=f9bfc2 desired=f9bfc2',
            'DONE'], res.splitlines())
