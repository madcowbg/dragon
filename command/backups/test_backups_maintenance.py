...
class TestBackupMaintenance(IsolatedAsyncioTestCase):
    ...
    async def test_move_files_after_backup(self):
        ...
        self.assertEqual((
            ...
            '|backup-repo-0       |      4|      3|       |       |       |      1|      '
            '1|\n'
            '|backup-repo-1       |      5|      3|      1|      1|       |      1|      '
            '1|\n'
            '|backup-repo-2       |      4|      2|      1|      1|       |      1|      '
            '1|\n'
            '|backup-repo-3       |      5|      2|      2|      2|       |      1|       '
            '|\n'
            '|repo-full           |     17|      9|      4|      4|      4|      4|      '
            '3|\n'
            '|work-repo-0         |      6|      5|       |       |       |      1|       '
            '|\n'
            '|work-repo-1         |      4|      4|       |       |       |       |       '
            ...
            '|cleanup|reserve|\n'
            '|backup-repo-0       |  5.5KB|  4.3KB|       |       |       |  1.2KB|  '
            '1.2KB|\n'
            '|backup-repo-1       |  5.9KB|  3.1KB|  1.2KB|  1.2KB|       |  1.6KB|  '
            '1.6KB|\n'
            '|backup-repo-2       |  6.2KB|  3.9KB|  1.2KB|  1.2KB|       |  1.2KB|  '
            '1.2KB|\n'
            '|backup-repo-3       |  6.2KB|  2.0KB|  2.7KB|  2.7KB|       |  1.6KB|       '
            '|\n'
            '|repo-full           | 21.9KB| 11.3KB|  5.1KB|  5.1KB|  5.1KB|  5.5KB|  '
            '3.9KB|\n'
        ...
        self.assertEqual((
            ...
            '|backup-repo-0       |  5.5KB|  4.3KB|       |       |       |  1.2KB|  '
            '1.2KB|\n'
            '|backup-repo-1       |  4.7KB|  3.1KB|       |       |       |  1.6KB|  '
            '1.6KB|\n'
            '|backup-repo-2       |  5.1KB|  3.9KB|       |       |       |  1.2KB|  '
            '1.2KB|\n'
        ...
        self.assertEqual((
            ...
            '|Size                |total  |availab|get    |copy   |move   '
            '|cleanup|reserve|\n'
            '|backup-repo-0       |  6.6KB|  4.3KB|  1.2KB|  1.2KB|  1.2KB|  1.2KB|  '
            '1.2KB|\n'
            '|backup-repo-1       |  6.2KB|  3.1KB|  1.6KB|  1.6KB|  1.6KB|  1.6KB|  '
            '1.6KB|\n'
